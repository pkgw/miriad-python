...
#
# miriad-python documentation build configuration file. Based off of
# the one used in OmegaPlot at the time.
#
# Copyright 2008 the Sphinx Team
#
# This file is a nearly-verbatim copy of one provided with Sphinx.
# Sphinx is distributed under the 2-clause BSD license. See the file
...
html_title = "miriad-python Manual"
...
# [howto/manual]).
latex_documents = [
  ('index', 'mirpy.tex', 'miriad-python Documentation',
